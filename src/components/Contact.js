        ...
        return (
            <div>
                <form onSubmit={this.props.onSubmitContact}>
                    ...
                    <input onChange={this.props.handleChange} value={jobSeeker.address} name="address" type="text" id="addressInput" placeholder='Address' /><br></br>
